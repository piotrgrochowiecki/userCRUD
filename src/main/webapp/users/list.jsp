...
<head>
    ...
    <meta name="description" content="userCRUD project done">
    <meta name="author" content="Piotr Grochowiecki">

    <title>userCRUD by Piotr Grochowiecki</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="list.jsp">
                <div class="sidebar-brand-text mx-3">userCRUD by Piotr Grochowiecki</div>
            </a>
